...
TRAIN=LINE/'sft_acceptance/ordinary_onpolicy_fp32_master_v8'
...
def freeze():
    ...
    template.update(id='Q35N_ORDINARY_FP32_MASTER_DEV_V8',checkpoint_role='base4000_plus_fp32master1000_optimizer5000_pure_model',
