...
import common as u
rgb_check=u.load("long100k_rgb_r3",Path(__file__).resolve().parent/"rgb.py")
...
old=u.load('long100k_frozen_sim',source)
route=u.load('long100k_route',u.LINE/'data_pipeline/ordinary_route_teacher_v11/route.py')
