...
TRAIN=LINE/'sft_acceptance/ordinary_route_teacher_v11'
...
def freeze():
    ...
    template.update(id='Q35N_ORDINARY_ROUTE_TEACHER_DEV_V11',checkpoint_role='base4000_plus_route_teacher1000_optimizer5000_pure_model',
...
def bind():
    ...
    assert str(ckpt)==final['latest_checkpoint'] and receipt['cursor']==dict(epoch=0,position=1000,updates=1000,decisions=tp['expected_final_cursor']['decisions'])
