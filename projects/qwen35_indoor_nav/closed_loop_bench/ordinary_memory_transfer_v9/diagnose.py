...
def summarize(seed):
    ...
    for arm in review.ARMS:
        ...
        for rank,row in sorted(found.items()):
            ...
            episodes.append(dict(rank=rank,episode_id=e['episode_id'],house=e['house'],category=category,
                ...
                full_window_and_memory_repeats=full_repeats,first_override=overrides[0] if overrides else None,
        ...
        arms[arm]=dict(episodes=episodes,stop_categories=dict(categories),
            ...
            full_window_and_memory_repeats=sum(e['full_window_and_memory_repeats'] for e in episodes),
    ...
    return dict(seed=seed,complete_quartets=100,sessions=sessions,arms=arms)
