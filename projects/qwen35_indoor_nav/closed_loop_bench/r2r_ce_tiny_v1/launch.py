...
def main():
    ...
    for name in ('frames','cache','cache/hf','cache/xdg','cache/torch','cache/triton','cache/cuda','cache/numba','cache/mpl','tmp'):
    ...
    try:
        ...
        resource_reasons={'FOREIGN_GPU_CONTEXT_APPEARED','WALL_BUDGET','GPU_MEMORY_BUDGET','CPU_MEMORY_BUDGET','OUTPUT_BUDGET'}
