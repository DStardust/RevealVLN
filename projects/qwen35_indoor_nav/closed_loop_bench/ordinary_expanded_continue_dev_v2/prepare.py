...
def freeze():
    ...
    template.update(id='Q35N_ORDINARY_EXPANDED_CONTINUE_DEV_V2',checkpoint_role='continued_8000_pure_model',
...
def bind():
    ...
    review=LINE/'reviews/Q35N_ORDINARY_CONTINUE_V2/FIRST_CHECKPOINT_ACCEPTANCE.json'
