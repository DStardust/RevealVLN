...
PARENT=HERE.parent/'Q35N_ORDINARY_R2R_ADAPT_V5/workflow.py'
...
def freeze():
    assert sha(PARENT)=='e951041755cf090b341ef0e520c504c5e0753546f3c0bb1bfa619e0aad4e0309'
    ...
    try:
        ...
        with (HERE/'eval_launcher.log').open('x') as log:
            ...
            while child.poll() is None:
                ...
                status('EVALUATING_FINAL_8000',own_launcher_pid=child.pid,elapsed_seconds=time.monotonic()-began);time.sleep(10)
