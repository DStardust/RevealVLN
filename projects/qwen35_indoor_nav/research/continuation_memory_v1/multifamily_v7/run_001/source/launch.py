...
import common as c
resource=c.load('v7_resource_manager',V5/'launch.py')
...
def main():
    ...
    if gpu['free_mib']<9216:
        c.write(HERE/'RESOURCE_BLOCK.json',dict(reason='INSUFFICIENT_FREE_MEMORY',selected=gpu,required_mib=9216))
        return
