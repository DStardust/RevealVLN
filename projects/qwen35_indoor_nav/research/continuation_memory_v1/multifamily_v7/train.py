"""Matched BC/state/crossed supervision on frozen causal features."""
import json
...
import common as c
models = c.load('v7_memory_model', HERE.parent / 'query_reader_repair_v2/model.py')
...
def losses(net, cache, batch, mode):
    ...
    return action_loss + auxiliary, stats, final
