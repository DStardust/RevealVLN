...
ROOT=HERE.parents[4]
PYTHON=Path(os.environ.get('V16_STANDALONE_PYTHON',Path('/mnt/data_nas/deeprobotics/daiyang/vla/.tools/python/cpython-3.10.20-linux-x86_64-gnu/bin/python3'))).resolve()
