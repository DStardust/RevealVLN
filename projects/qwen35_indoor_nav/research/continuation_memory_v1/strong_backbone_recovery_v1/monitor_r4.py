...
class Handler(previous.Handler):
    def do_GET(self):
        ...
        if self.path=='/api/transfer':
            ...
            body=page.replace('<h1>',TRANSFER_CARD+CARD+previous.base.CARD+'<h1>',1).encode();mime='text/html; charset=utf-8'
