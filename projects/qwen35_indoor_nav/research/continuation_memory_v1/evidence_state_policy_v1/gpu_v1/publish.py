...
def snapshot(run):
    ...
    sources=[CPU,run,HERE/'standalone_jobs']
...
入口：[协议]({base}/gpu_v1/PROTOCOL.json)、[运行说明]({base}/gpu_v1/README.md)、[模型]({base}/model.py)、[损失]({base}/objective.py)、[Jev 只读调研]({base}/JEV_RESEARCH_NOTE_ZH.md)。
