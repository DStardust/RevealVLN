...
def snapshot(output):
    ...
    source=WF/'scout_next_v1/shard_0/run_v1';locks={};cache={};trace_digests={}
    ...
    for path in [HERE.parent/'method.py',HERE/'prepare.py',WF/'bank_cpu/bank.py',WF/'compatibility_cpu/audit.py',
