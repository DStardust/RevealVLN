...
from bulk_scout_scoped_common_00 import (RUNTIME,ROOT,Compiler,compiler,digest,BudgetExceeded,Journal,durable_budget,
        ...
        with store_class()(out/'content',6*1024**3) as store,Journal(out/'journal',cfg) as journal:
            ...
            for candidate in cfg['candidates']:
                ...
                try:
                    ...
                    backend=HabitatBackend(candidate['scene_glb'],1,candidate['roles'],store,dict(cfg,scene_glb=candidate['scene_glb']))
