...
import sys
HERE=Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/bulk_source_v1/shard_00/bank_snapshots')
WF=Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1')
RUNTIME=WF.parent
ROOT=RUNTIME.parents[3]
sys.path.insert(0,'/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/winding_balance_v1')
...
def snapshot(output):
    ...
    if output.exists() or output.parent!=HERE or not output.name.startswith('snapshot'):raise ValueError('FRESH_SNAPSHOT_REQUIRED')
    source=Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/bulk_source_v1/shard_00/run_v1');locks={};cache={};trace_digests={}
    ...
    for path in [Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/winding_balance_v1/method.py'),Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/bulk_source_v1/adapters.py'),Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/winding_balance_v1/next_source_v1/prepare.py'),WF/'bank_cpu/bank.py',WF/'compatibility_cpu/audit.py',
