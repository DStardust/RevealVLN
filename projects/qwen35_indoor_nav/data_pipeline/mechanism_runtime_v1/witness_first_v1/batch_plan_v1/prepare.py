...
from balanced import solve,matched,closed,FamilyFactory
...
def snapshot(output):
        ...
        for index,hub in enumerate(frozen['hubs']):
            ...
            for proposal in offered['proposals']:
                ...
                candidate={'candidate_id':'WF_BATCH_'+ident,'house_id':house,'hub_index':index,'hub_key':proposal['hub_key'],
                    ...
                    'control_type':'completed_subgoal_revisit_or_irrelevant_loop_placement',
    ...
    for path in [HERE/'balanced.py',HERE/'prepare.py',WF/'bank_cpu/bank.py',WF/'compatibility_cpu/audit.py',
    ...
    products={'CONFIG_DRAFT.json':{'node':'Q35N_WITNESS_BALANCED_BATCH_V1','runtime_allowed':False,'executable':False,
