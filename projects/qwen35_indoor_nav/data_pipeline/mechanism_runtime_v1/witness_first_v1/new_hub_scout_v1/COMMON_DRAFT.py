...
RUNTIME=Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1')
ROOT=RUNTIME.parents[3]
LINE=RUNTIME.parents[1]
sys.path[:0]=[str(RUNTIME),str(RUNTIME/'feedback_generation_v1'),str(Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/budget_and_trace'))]
...
bank=load('scout_frozen_bank',Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/bank_cpu/bank.py'))
...
_new_hub_selector=load("scoped_new_hub_selector",Path('/mnt/data_nas/deeprobotics/daiyang/vla/projects/qwen35_indoor_nav/data_pipeline/mechanism_runtime_v1/witness_first_v1/new_hub_scout_v1/selector.py'))
def select_hubs(backend,role_rows,positions,budget,target_function=candidate_targets):
    return _new_hub_selector.runtime_select(_original_select_four_hubs,backend,role_rows,positions,budget,runtime_config(),target_function)
