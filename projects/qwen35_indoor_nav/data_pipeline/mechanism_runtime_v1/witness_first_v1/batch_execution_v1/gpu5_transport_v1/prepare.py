...
from pathlib import Path
HERE=Path(__file__).resolve().parent
spec=importlib.util.spec_from_file_location('gpu5_frozen_transport',HERE.parent/'gpu5_transport_v1/transport.py')
module=importlib.util.module_from_spec(spec);spec.loader.exec_module(module)
...
def prepare(snapshot,name,indices,authorization,holder_identity):
    ...
    module.GPU5_TRANSPORT_METADATA={'gpu5_transport_version':'gpu5_transport_v1',
