...
OLD=HERE.parent/'monitor_charts_expanded_v1/server_r1.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=2062178
...
def check(port):
    ...
    assert d['monitor_version']=='ordinary_targeted_v1'
    ...
    assert d['navigation']['before']['result']['sr']==.14 and d['navigation']['after_batch8']['result']['sr']==.17
...
def main():
    ...
    protected={pid:ident(pid) for pid in (2099035,2099174,2099284,3996270,112240,1563749,1353421)}
