...
OLD=HERE.parent/'monitor_charts_policy_preservation_v9/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3423298
...
def protected_pids():
    owner=json.loads((LINE/'reviews/Q35N_ORDINARY_ACTION_ALIGNED_HISTORY_V10/SEAL.json').read_text())['owned_training_lease']
