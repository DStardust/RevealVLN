...
```bash
.tools/python/cpython-3.10.20-linux-x86_64-gnu/bin/python3 -I -S -B projects/qwen35_indoor_nav/sft_acceptance/ordinary_execution_v1/monitor/server.py
```
...
```bash
.tools/python/cpython-3.10.20-linux-x86_64-gnu/bin/python3 -I -S -B projects/qwen35_indoor_nav/sft_acceptance/ordinary_execution_v1/monitor/test_server.py
```
