...
def main():
    ...
    for number in range(1, 4):
        ...
        env.update(CUDA_VISIBLE_DEVICES=','.join(protocol['gpus']), HF_HUB_OFFLINE='1',
                   ...
                   NCCL_IB_DISABLE='1', PYTORCH_CUDA_ALLOC_CONF='expandable_segments:True',
        ...
        argv = [str(PY), '-B', '-m', 'torch.distributed.run', '--standalone', '--nproc_per_node=3',
                str(HERE / 'train.py'), '--protocol', str(HERE / 'PROTOCOL.json'),
