...
changes={
"OLD=HERE.parent/'monitor_charts_expanded_v1/server_r1.py';NEW=HERE/'server.py'":"OLD=HERE.parent/'monitor_charts_r2r_adapt_v5/server.py';NEW=HERE/'server.py'",
"PANE='%294';OLD_PID=2062178":"PANE='%294';OLD_PID=2738357",
"d['monitor_version']=='ordinary_targeted_v1'":"d['monitor_version']=='ordinary_r2r_adapt_v5r1'",
...
def protected_pids():
    ...
    case=line/'closed_loop_bench/ordinary_r2r_adapt_dev_v5r1'
