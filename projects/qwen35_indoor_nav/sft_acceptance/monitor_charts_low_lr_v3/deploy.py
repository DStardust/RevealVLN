...
replacements={
 "OLD=HERE.parent/'monitor_charts_expanded_v1/server_r1.py';NEW=HERE/'server.py'":"OLD=HERE.parent/'monitor_charts_continue_v2/server.py';NEW=HERE/'server.py'",
 "PANE='%294';OLD_PID=2062178":"PANE='%294';OLD_PID=2482169",
 "d['monitor_version']=='ordinary_targeted_v1'":"d['monitor_version']=='ordinary_low_lr_v3'",
...
def live_training_pids():
    ...
    for g in root.findall('gpu')[3:6]:
        ...
        assert str(HERE.parent/'ordinary_expanded_low_lr_v3/train_filestore.py') in argv
        result.append(pid)
