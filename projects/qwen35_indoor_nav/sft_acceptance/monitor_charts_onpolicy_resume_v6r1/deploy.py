...
OLD=HERE.parent/'monitor_charts_onpolicy_train_v6r1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=2898271
...
def check(port):
    ...
    assert d['monitor_version']=='ordinary_onpolicy_resume_v6r1'
