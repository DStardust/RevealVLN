...
def main():
    ...
    sources = [OLD/'SHA256SUMS', OLD/'SPLIT.json', OLD/'EXPERIMENT_SPEC.json', OLD/'result.json',
               OLD/'recovery_r1/policy.py', OUT.parent/'d1_v1/worker.py', OUT.parent/'efficiency_run_v1/worker.py', LINE/'.envs/q35n_qwen_g2_v1/lib/python3.10/site-packages/transformers/models/qwen3_5/modeling_qwen3_5.py', OUT.parent/'efficiency_v1/frozen_cache.py', OLD/'checkpoints/initial.pt', OLD/'recovery_r1/checkpoints/terminal.pt',
