...
import common as u
rgb_check=u.load("survival17_rgb_r3",Path(__file__).resolve().parent/"rgb.py")
...
old=u.load('survival17_frozen_sim',source)
route=u.load('survival17_route',u.LINE/'data_pipeline/ordinary_route_teacher_v11/route.py')
