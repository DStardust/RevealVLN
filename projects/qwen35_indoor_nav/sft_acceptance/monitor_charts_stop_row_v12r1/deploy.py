...
OLD=HERE.parent/'monitor_charts_stop_row_v12/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3653164
...
def check(port):
    d=json.loads(fetch(port));assert d['monitor_version']=='ordinary_stop_row_v12r1'
