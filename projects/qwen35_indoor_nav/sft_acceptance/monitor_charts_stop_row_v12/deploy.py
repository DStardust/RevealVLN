...
OLD=HERE.parent/'monitor_charts_route_teacher_training_v11/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3592395
...
def check(port):
    d=json.loads(fetch(port));assert d['monitor_version']=='ordinary_stop_row_v12'
    assert d['stop_row']['build']['unique_inputs']==5487
