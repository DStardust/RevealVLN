...
OLD=HERE.parent/'monitor_charts_fp32_master_v8/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3007724
...
def protected_pids():
    owner=json.loads((LINE/'reviews/Q35N_ORDINARY_FP32_MASTER_V8_TRANSPORT_R1/SEAL.json').read_text())['owned_training_lease']
