...
TRAIN=HERE.parent/'ordinary_onpolicy_adapt_v6'
...
def collect(include_gpu=True):
    d=m.collect(include_gpu=include_gpu);d['monitor_version']='ordinary_onpolicy_train_v6r1'
    history=[]
    try:
    ...
    d['onpolicy_training']=dict(progress=read(TRAIN/'formal/attempt_001/PROGRESS.json'),
