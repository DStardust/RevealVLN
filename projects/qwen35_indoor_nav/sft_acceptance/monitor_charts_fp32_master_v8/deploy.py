...
OLD=HERE.parent/'monitor_charts_equal_merge_v7r1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=2987721
...
def protected_pids():
    owner=json.loads((LINE/'reviews/Q35N_ORDINARY_FP32_MASTER_V8/SEAL.json').read_text())['owned_training_lease']
