...
OLD=HERE.parent/'monitor_charts_stop_row_v12r1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3656439;OLD_START=166003167
...
def check(port):
    d=json.loads(fetch(port));assert d['monitor_version']=='ordinary_sr40_v1'
    ...
    assert d['sr40_training'] is None and d['sr40_full_result'] is None
...
def protected_pids():
    return (3607568,3607686,3607782,3996270,112240,1563749,1353421)
