...
import common as u
rgb_check=u.load("calibrated19_rgb_r3",Path(__file__).resolve().parent/"rgb.py")
...
old=u.load('calibrated19_frozen_sim',source)
route=u.load('calibrated19_route',u.LINE/'data_pipeline/ordinary_route_teacher_v11/route.py')
