...
c=load('calibrated19_frozen_io',V5/'common.py')
...
def audit_episode(folder,index,gt_path,collection=False):
    ...
    aggregate=load('calibrated19_frozen_metric_audit',LINE/'closed_loop_bench/ordinary_cycle_pair_gpu1_v3/aggregate.py')
