...
OLD=HERE.parent/'monitor_charts_history8_pair_v1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3740279;OLD_START=166945786
...
def check(port):
    d=json.loads(fetch(port));assert d['monitor_version']=='ordinary_history8_pair_r1'
...
def protected_pids():
    return (3747280,3747372,3747456,3996270,112240,1563749,1353421)
