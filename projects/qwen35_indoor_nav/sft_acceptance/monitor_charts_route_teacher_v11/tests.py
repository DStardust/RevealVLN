...
assert d['monitor_version']=='ordinary_route_teacher_data_v11'
...
assert d['onpolicy_training']['view_audit']['planned_view_target_conflicts']==0
assert d['onpolicy_training']['frame_stride']==8

assert m['CASE']==m['LINE']/'closed_loop_bench/ordinary_action_aligned_history_dev_v10'
assert m['TRAIN']==m['LINE']/'sft_acceptance/ordinary_action_aligned_history_v10'
assert d['onpolicy_training']['eval_progress']['unix']>d['onpolicy_training']['training_result']['unix']

assert d['route_teacher_data']['source_dir']==str(m['LINE']/'data_pipeline/ordinary_route_teacher_v11/run_001')
assert d['onpolicy_training']['eval_result']['sr']==.19 and not d['onpolicy_training']['positive_navigation_result']
