...
OLD=HERE.parent/'monitor_charts_action_aligned_history_v10r1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3550921
...
def protected_pids():
    owner=ident(3575708)
    assert owner['argv']==[str(PY),'-I','-S','-B',str(LINE/'data_pipeline/ordinary_route_teacher_v11/launch.py')] and owner['cwd']==str(ROOT)
