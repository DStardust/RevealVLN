...
OLD=HERE.parent/'monitor_charts_fp32_master_v8r1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3030628
...
def protected_pids():
    owner=json.loads((LINE/'reviews/Q35N_ORDINARY_POLICY_PRESERVATION_V9/SEAL.json').read_text())['owned_training_lease']
