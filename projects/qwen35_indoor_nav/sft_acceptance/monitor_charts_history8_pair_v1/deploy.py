...
OLD=HERE.parent/'monitor_charts_sr40_v1/server.py';NEW=HERE/'server.py'
PANE='%294';OLD_PID=3696171;OLD_START=166411234
...
def check(port):
    d=json.loads(fetch(port));assert d['monitor_version']=='ordinary_history8_pair_v1'
