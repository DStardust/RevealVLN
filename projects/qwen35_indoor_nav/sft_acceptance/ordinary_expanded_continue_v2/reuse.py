...
def source(name):
    ...
    if name=='train_filestore.py':
        replacements={"'Q35N_ORDINARY_EXPANDED_V1'":"'Q35N_ORDINARY_EXPANDED_CONTINUE_V2'",
            "HERE / 'SAMPLE_INDEX.jsonl'":"HERE.parent / 'ordinary_expanded_v1/SAMPLE_INDEX.jsonl'"}
    if name=='supervise_filestore.py':
        replacements={'triton_ordinary_expanded_v1':'triton_ordinary_expanded_continue_v2',
                      'inductor_ordinary_expanded_v1':'inductor_ordinary_expanded_continue_v2'}
