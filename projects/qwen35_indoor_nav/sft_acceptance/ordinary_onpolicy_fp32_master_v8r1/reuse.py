...
def source(name):
    ...
    if name=='train_filestore.py':
        changes={"'Q35N_ORDINARY_ONPOLICY_ADAPT_V6'":"'Q35N_ORDINARY_FP32_MASTER_V8_TRANSPORT_R1'",
    ...
    if name=='supervise_filestore.py':
        changes={'triton_ordinary_onpolicy_adapt_v6':'triton_ordinary_fp32_master_v8r1','inductor_ordinary_onpolicy_adapt_v6':'inductor_ordinary_fp32_master_v8r1'}
