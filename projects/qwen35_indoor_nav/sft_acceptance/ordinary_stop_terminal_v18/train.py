...
obj=u.load('terminal18_objective',u.HERE/'objective.py')
...
def main(run):
    ...
    old=u.load('terminal18_shared_builder',u.HERE.parent/'ordinary_action_repair_v16/train.py')
    ...
    fit=u.load('terminal18_old_weights',u.LINE/'sft_acceptance/ordinary_stop_row_v12/fit.py');split=u.read(Path(cfg['manifests'])/'SPLIT.json');fits=[]
