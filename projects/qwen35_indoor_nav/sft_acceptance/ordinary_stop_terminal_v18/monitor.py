...
s=importlib.util.spec_from_file_location('terminal18_previous_monitor',OLD/'ops_recovery_r1/monitor.py');base=importlib.util.module_from_spec(s);s.loader.exec_module(base)
