...
import common as u
rgb_check=u.load("contrast20_rgb_r3",Path(__file__).resolve().parent/"rgb.py")
...
old=u.load('contrast20_frozen_sim',source)
route=u.load('contrast20_route',u.LINE/'data_pipeline/ordinary_route_teacher_v11/route.py')
