#!/usr/bin/env python3
"""Close automatic scale-v1 prefixes with the frozen full-set prompt."""
...
gate.OUTPUT_REVISION = "rxr-scale-v1-causal-prefix-language-gate/1"
gate.USE_ALL_BRANCHES = True
gate.RESPONSE_SCHEMA_VERSION = "revealnav-fullset-causal-prefix-language-v2"
gate.REQUEST_REVISION = "rxr-scale-v1-causal-prefix-language-request/1"
...
def main() -> int:
    ...
    if missing:
        raise SystemExit(f"scale causal media missing for {len(missing)} events")
