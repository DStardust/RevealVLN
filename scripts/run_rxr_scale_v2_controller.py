#!/usr/bin/env python3
"""Execute every scale-v2 geometry survivor with the frozen controller."""
...
BASE = ROOT / "artifacts/phase1/rxr_train_expansion/scale_v2/automatic/multibranch"
gate.GEOMETRY = BASE / "RXR_SCALE_MULTIBRANCH_GEOMETRY.json"
gate.OUT = BASE / "RXR_SCALE_MULTIBRANCH_CONTROLLER.json"
gate.OUTPUT_MANIFEST = "RevealNav RxR scale-v2 automatic multibranch controller"
gate.OUTPUT_REVISION = "rxr-scale-v2-multibranch-controller/1"
gate.OUTPUT_SCOPE = "all branches in scale-v2 geometry survivors"
