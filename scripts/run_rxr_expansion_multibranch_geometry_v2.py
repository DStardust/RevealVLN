#!/usr/bin/env python3
"""Ground every proposed executable branch for the MF2-CR6 v2 dataset."""
...
gate.OUT = OUT_DIR / "RXR_MULTIBRANCH_DIRECTED_GEOMETRY_V2.json"
gate.ELIGIBLE_DISPOSITIONS = {
    "TO_DIRECTED_GEOMETRY", "RELOCATE_EARLIER_THEN_3D",
}
gate.OUTPUT_MANIFEST = "RevealNav RxR MF2-CR6 multibranch directed geometry"
gate.OUTPUT_REVISION = "rxr-multibranch-directed-geometry/2"
gate.OUTPUT_SCOPE = "RxR-train proposals retaining every verified branch"
