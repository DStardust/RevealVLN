#!/usr/bin/env python3
"""Extract and validate the automatic scale-v2 frozen feature manifest."""
...
features.WORKER = ROOT / "scripts/rxr_scale_v2_feature_lane.py"
...
features.RECORD_EXTRA = {
    "label_source": "automatic_scale_v2_pseudolabel",
